...
urlpatterns = patterns('',
    ...
    (r'^cobbler_web/(?P<what>\w+)/genlist(/(?P<page>\d+))?', genlist),
    ...
    (r'^cobbler_web/(?P<what>\w+)/copy/(?P<obj_name>.+)$', generic_edit, {'editmode': 'copy'}),
    ...
    (r'^cobbler_web/(?P<what>\w+)/genedit$', generic_edit),
    (r'^cobbler_web/(?P<what>\w+)/genedit/(?P<obj_name>.+)$', generic_edit, {'editmode': 'edit'}),
    (r'^cobbler_web/(?P<what>\w+)/gensave$', generic_save),
)
