...
* To retain the apt settings inlcuded on the live ISO installer (default Ubuntu official sources), the ``apt:`` section should inlcude the ``preserve_sources_list: false`` option:
