...
cobbler-register [--server=<cobbler.example.org>] --profile=<cobbler-profile-name> [--hostname=<hostname>] 
...
Reading the cobbler manpage, the koan manpage, and fedorahosted.org/cobbler is highly recommended. 
