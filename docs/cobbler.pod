...
the API and XMLRPC components are available online at http://cobbler.github.com.
...
Cobbler also makes itself available as an XMLRPC API for use by higher level management software.  Learn more at http://cobbler.github.com.  
...
Official web site, bug tracker, and Wiki: http://cobbler.github.com
