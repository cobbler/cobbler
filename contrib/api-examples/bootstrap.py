...
def download_iso(url: str, path: str):
    """
...
def mount_iso(path: str, target_folder: str):
    """
...
def cobbler_mkloaders(cobbler_api: "CobblerXMLRPCInterface", token: str):
    """
...
def cobbler_sync_full(cobbler_api: "CobblerXMLRPCInterface", token: str):
    """
    Call Cobbler Sync
    """
