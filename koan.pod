...
When using --virt, koan will create new virtualized guests on a machine in accordance to the orders from cobbler.  You can then, once finished, use "virsh" or "virt-manager" to access the guest.  These can be Xen or QEMU/KVM guests.
