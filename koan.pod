...
Specifies the virtualized bridge to use, instead of the one as defined in cobbler.  For profiles, this must be a single bridge.  For system records that define multiple interfaces, multiple bridge names can be seperated with commas.
...
https://fedorahosted.org/cobbler is also highly recommended.

The mailing list is cobbler@lists.fedorahosted.org.  Subscribe at https://fedorahosted.org/mailman/listinfo/cobbler
