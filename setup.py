...
if __name__ == "__main__":
    ...
    setup(
        ...
        data_files=[
            ...
            ("%ssettings.d" % etcpath, glob("collections/settings.d/*")),
            ...
            ("%scollections/distros.d" % libpath, []),
            ("%scollections/images.d" % libpath, []),
            ("%scollections/profiles.d" % libpath, []),
            ("%scollections/repos.d" % libpath, []),
            ("%scollections/systems.d" % libpath, []),
            ("%scollections/mgmtclasses.d" % libpath, []),
            ("%scollections/packages.d" % libpath, []),
            ("%scollections/files.d" % libpath, []),
