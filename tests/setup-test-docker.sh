...
zypper -n update
zypper -n in python3 python3-devel python3-pip python3-setuptools python3-distro python3-future python3-coverage apache2 apache2-devel acl apache2-mod_wsgi-python3 ipmitool rsync fence-agents genders xorriso python3-ldap tftp python3-Sphinx hardlink
