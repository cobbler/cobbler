...
class TestDistroProfileSystem(CobblerXmlRpcTest):
    """
...
class TestRepo(CobblerXmlRpcTest):
...
class TestMgmtClass(CobblerXmlRpcTest):
...
class TestFile(CobblerXmlRpcTest):
    """
...
class TestItem(CobblerXmlRpcTest):
    """
    Test item
    """
...
class TestNonObjectCalls(CobblerXmlRpcTest):
