...
def test_built_in_cloud_init_module_ca_certs(cobbler_api: CobblerAPI):
    """
    Test to verify the rendering of the built-in Cloud-Init addons XML snippet.
    """
    # Arrange
...
def test_built_in_cloud_init_module_scripts_per_boot(cobbler_api: CobblerAPI):
    """
    Test to verify the rendering of the built-in Cloud-Init scripts per boot snippet.
    """
    # Arrange
    target_template = cobbler_api.find_template(
        False, False, name="built-in-cloud-init-module-scripts-per-boot"
    )
    if target_template is None or isinstance(target_template, list):
        pytest.fail("Target template not found!")
    meta: Dict[str, Any] = {}
...
def test_built_in_cloud_init_module_scripts_per_instance(cobbler_api: CobblerAPI):
    """
    Test to verify the rendering of the built-in Cloud-Init scripts per instance snippet.
    """
    # Arrange
    target_template = cobbler_api.find_template(
        False, False, name="built-in-cloud-init-module-scripts-per-instance"
    )
    if target_template is None or isinstance(target_template, list):
        pytest.fail("Target template not found!")
    meta: Dict[str, Any] = {}
...
def test_built_in_cloud_init_module_scripts_per_once(cobbler_api: CobblerAPI):
    """
    Test to verify the rendering of the built-in Cloud-Init scripts per once snippet.
    """
    # Arrange
    target_template = cobbler_api.find_template(
        False, False, name="built-in-cloud-init-module-scripts-per-once"
    )
    if target_template is None or isinstance(target_template, list):
        pytest.fail("Target template not found!")
    meta: Dict[str, Any] = {}
...
def test_built_in_cloud_init_module_scripts_user(cobbler_api: CobblerAPI):
    """
    Test to verify the rendering of the built-in Cloud-Init scripts user snippet.
    """
    # Arrange
    target_template = cobbler_api.find_template(
        False, False, name="built-in-cloud-init-module-scripts-user"
    )
    if target_template is None or isinstance(target_template, list):
        pytest.fail("Target template not found!")
    meta: Dict[str, Any] = {}
...
def test_built_in_cloud_init_module_scripts_vendor(cobbler_api: CobblerAPI):
    """
    Test to verify the rendering of the built-in Cloud-Init scripts vendor snippet.
    """
    # Arrange
    target_template = cobbler_api.find_template(
        False, False, name="built-in-cloud-init-module-scripts-vendor"
    )
    if target_template is None or isinstance(target_template, list):
        pytest.fail("Target template not found!")
    meta: Dict[str, Any] = {}
...
def test_built_in_cloud_init_module_set_hostname(cobbler_api: CobblerAPI):
    """
...
def test_built_in_cloud_init_module_set_passwords(cobbler_api: CobblerAPI):
    """
...
def test_built_in_cloud_init_module_zypper_add_repo(cobbler_api: CobblerAPI):
    """
