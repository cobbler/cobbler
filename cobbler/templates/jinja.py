    ...
    def render(self, raw_data: str, search_table: Dict[str, Any]) -> str:
        try:
            if self.api.settings().jinja2_includedir:
                template = jinja2.Environment(  # type: ignore[reportOptionalMemberAccess]
                    loader=jinja2.FileSystemLoader(  # type: ignore[reportOptionalMemberAccess]
                ...
                template = jinja2.Template(raw_data)  # type: ignore[reportOptionalMemberAccess]
