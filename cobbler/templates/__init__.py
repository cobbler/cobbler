...
TEMPLATE_TAG_MAPPING: Dict[str, enums.TemplateTag] = {
    ...
    "isolinux_menuentry.template": enums.TemplateTag.ISO_ISOLINUX_MENUENTRY,
        ...
        for package in pkgutil.iter_modules([str(template_providers)]):
            ...
            for element in inspect.getmembers(template_provider):
                if (
                    ...
                    self.__loaded_template_providers[element[1].template_language] = (
                        element[1](self.api)
                    )
        self.logger.info(
