    ...
    def get_field_info(self):
        return {
            ...
            'kernel_options' : {
                'input_type' : 'str',
                'width'      : 40,
                'header'     : 'kernel_options',
                'tooltip'    : 'kernel_options',
                'default'    : '',
            },
            'kernel_options_post' : {
                'input_type' : 'str',
                'width'      : 40,
                'header'     : 'kernel_options_post',
                'tooltip'    : 'kernel_options_post',
                'default'    : '',
            },
            'depth' : {
                'input_type' : 'str',
            ...
            'interfaces' : {
                ...
                'fields'     : {
                    'key' : {
                        ...
                        'tooltip'    : 'Interface name as used by Linux,e.g. ethX, bondX, ethX.VLAN, bondX.VLAN',
                        'default'    : '',
                    },
                    'network' : {
                        'input_type' : 'str',
                    ...
                    'bonding_master' : {
                        'input_type' : 'str',
                        'width'      : 40,
                        'header'     : 'bonding_master',
                        'tooltip'    : 'bonding_master',
                        'default'    : '',
                    },
                    'bonding_opts' : {
                        'input_type' : 'str',
                    ...
                    'static_routes' : {
                        'input_type' : 'str',
                        'width'      : 40,
                        'header'     : 'static_routes',
                        'tooltip'    : 'static_routes',
                        'default'    : '',
                    },
                    'dns_name' : {
                        'input_type' : 'str',
            ...
            'netboot_enabled' : {
                'input_type' : 'str',
                'width'      : 40,
                'header'     : 'netboot_enabled',
                'tooltip'    : 'netboot_enabled',
                'default'    : '',
                'webui_default' : True,
            },
            'owners' : {
            ...
            'virt_file_size' : {
                'input_type' : 'str',
                'width'      : 40,
                'header'     : 'virt_file_size',
                'tooltip'    : 'virt_file_size',
                'default'    : '',
            },
            'virt_path' : {
                'input_type' : 'str',
            ...
            'virt_auto_boot' : {
                'input_type' : 'str',
                'width'      : 40,
                'header'     : 'virt_auto_boot',
                'tooltip'    : 'virt_auto_boot',
                'default'    : '',
            },
            'virt_type' : {
                'input_type' : 'str',
            ...
            'power_address' : {
                'input_type' : 'str',
                'width'      : 40,
                'header'     : 'power_address',
                'tooltip'    : 'power_address',
                'default'    : '',
            },
            'power_user' : {
                'input_type' : 'str',
            ...
            'name_servers' : {
                ...
                'width'      : 40,
                'header'     : 'name_servers',
                'tooltip'    : 'name_servers',
                'default'    : '',
            },
            'name_servers_search' : {
                'input_type' : 'str',
                'width'      : 40,
                'header'     : 'name_servers_search',
                'tooltip'    : 'name_servers_search',
                'default'    : '',
            },
            'redhat_management_key' : {
                'input_type' : 'str',
                'width'      : 40,
                'header'     : 'redhat_management_key',
                'tooltip'    : 'redhat_management_key',
                'default'    : '',
            },
            'redhat_management_server' : {
                'input_type' : 'str',
                'width'      : 40,
                'header'     : 'redhat_management_server',
                'tooltip'    : 'redhat_management_server',
                'default'    : '',
            },
        }
