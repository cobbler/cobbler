...
DEFAULTS = {
    ...
    "autoinstall_snippets_dir": ["/var/lib/cobbler/autoinstall_snippets", "str"],
    "autoinstall_templates_dir": ["/var/lib/cobbler/autoinstall_templates", "str"],
    ...
    "smc_track_author": ["cobbler <cobbler@localhost>", "str"],
