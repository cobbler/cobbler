...
DEFAULTS = {
    ...
    "redhat_management_org": ["", "str"],
    "redhat_management_user": ["", "str"],
    "redhat_management_password": ["", "str"],
...
def validate_settings(settings_content: dict) -> dict:
    ...
    schema = Schema({
        ...
        Optional("redhat_management_permissive", False): bool,
        Optional("redhat_management_server", default="xmlrpc.rhn.redhat.com"): str,
        Optional("redhat_management_key", default=""): str,
        Optional("redhat_management_org", default=""): str,
        Optional("redhat_management_user", default=""): str,
        Optional("redhat_management_password", default=""): str,
