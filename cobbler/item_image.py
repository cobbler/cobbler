...
FIELDS = [
   ...
   [ 'file'            , '', 0, "Image file path", True ],
   [ 'parent'          , '', 0, "", False],
   [ 'depth'           , 0,  0, "", False],
   [ 'virt_auto_boot'  , "SETTINGS:virt_auto_boot", 0, "Auto boot this VM?", True   ],
   ...
   [ 'virt_cpus'       , 1,  0, "Virt CPU Count", True],
   [ 'network_count'   , 1,  0, "Virt NIC count", True],
   ...
   [ 'ctime'           , 0,  0, "", False],
   [ 'mtime'           , 0,  0, "", False],
   [ 'kickstart'       , '', 0, "Kickstart template path", True]
]
