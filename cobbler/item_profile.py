...
FIELDS = [
  ...
  ["uid","","","",False,""],
  ["owners","SETTINGS:default_ownership","SETTINGS:self.settings.default_ownership","Owners",False,""],
  ["distro",None,'<<inherit>>',"Distribution",True,""],
  ["enable_menu","SETTINGS:enable_menu",'<<inherit>>',"Enable PXE Menu?",True,""],
  ["kickstart","SETTINGS:default_kickstart",'<<inherit>>',"Kickstart",True,""],
  ["kernel_options",{},'<<inherit>>',"Kernel Options",True,""],
  ["kernel_options_post",{},'<<inherit>>',"Kernel Options (Post Install)",True,""],
  ["ks_meta",{},'<<inherit>>',"Kickstart Metadata",True,""],
  ["template_files",{},'<<inherit>>',"Template Files",True,""],
  ["virt_auto_boot","SETTINGS:virt_auto_boot",'<<inherit>>',"Virt Auto Boot",True,""],
  ["virt_cpus",1,'<<inherit>>',"Virt CPUs",True,""],
  ...
  ["redhat_management_server","<<inherit>>","<<inherit>>","Red Hat Management Server",True,""]
]
